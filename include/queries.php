...
//class user
	...
	"getLogins" => "SELECT logins FROM users WHERE userID = ?", //ret int, int
	"getMessageBoardID" => "SELECT messageBoardID FROM users WHERE userID = ?", //ret int, int
	...
	//setters
	"createNewUser" => "INSERT INTO users (username, password, password_creation_date, user_creation_date, firstname, lastname, pro_pic_loc, about, logins, last_login_date, messageBoardID) VALUES (?, SHA1(?), NOW(), NOW(), ?, ?, ?, ?, 1, NOW(), ?)", //string string string string string string int 
